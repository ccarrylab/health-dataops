...
output "emr_serverless_app_id" {
  value = module.emr.serverless_app_id
}

output "raw_bucket" {
  value = module.s3_data_lake.raw_bucket
}

output "curated_bucket" {
  value = module.s3_data_lake.gold_bucket
}

output "artifact_bucket" {
  value = module.s3_data_lake.silver_bucket
}

output "dag_bucket" {
  value = module.s3_data_lake.dag_bucket
}
